      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a href="paneladmin.php" class="nav-link pc">
            <i> <img src="agregarblanco.png" width="15px"> </img>&nbsp;&nbsp;</i> Administrar cuenta</a>
          </a>
        </li>
        <li class="nav-item">
  ...
  <div class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li class="sidebar-menu-item">
        <a href="paneladmin.php" class="sidebar-menu-link dc" style="
    color: white;
">
      ...
      <li class="sidebar-menu-item">
        <a href="agrega_lugar.php" class="sidebar-menu-link dc">
          <i class="fa fa-plus dc" aria-hidden="true"></i>Sensor mlad1dht
        </a>
      </li>
      <li class="sidebar-menu-item active">
        <a href="agrega_cliente.php" class="sidebar-menu-link ">
          <i class="fa fa-plus dc" aria-hidden="true"></i> Sensor mlad2dht
        </a>
      </li>
      <li class="sidebar-menu-item">
        <a href="validar.php" class="sidebar-menu-link dc">
          <i class="far fa-file-alt dc" aria-hidden="true"></i> Evaluaciones
        </a>
      </li>
      <li class="sidebar-menu-item ">
        <a href="vistaadmin.php" class="sidebar-menu-link dc">
          <i> <img src="Resultados.png" width="15px"> </img>&nbsp;&nbsp;</i>Resultados</a>
        </a>
      </li>
      <li class="sidebar-menu-item ">
        <a href="cerrar.php" class="sidebar-menu-link dc">
          <i class="fas fa-sign-out-alt"></i> &nbsp;&nbsp;Cerrar sesion</a>
        </a>
      </li>
    </ul>
  ...
  function actualizarGrafica2() {
    fetch('/obtener-datos-grafica2')
      ...
      .then(data => {
        ...
        data.forEach(dato => {
          myChart2.data.labels.push(dato.fecha_hora_mlad2dht);
          myChart2.data.datasets[0].data.push(parseFloat(dato.temperatura_mlad2dht));
          myChart2.data.datasets[1].data.push(parseFloat(dato.humedad_mlad2dht));
        });
