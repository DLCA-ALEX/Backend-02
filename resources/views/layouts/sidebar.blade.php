...
">
      ...
      <li class="sidebar-menu-item active">
        <a href="agrega_lugar.php" class="sidebar-menu-link ">
  ...
  function actualizarGrafica() {
    fetch('/obtener-datos-grafica')
      ...
      .then(data => {
        ...
        data.forEach(dato => {
          myChart1.data.labels.push(dato.fecha_hora_mlad1dht);
          myChart1.data.datasets[0].data.push(parseFloat(dato.temperatura_mlad1dht));
          myChart1.data.datasets[1].data.push(parseFloat(dato.humedad_mlad1dht));
        });
