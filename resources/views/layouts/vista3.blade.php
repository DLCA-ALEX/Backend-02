...
">
      ...
      <li class="sidebar-menu-item ">
        <a href="agrega_cliente.php" class="sidebar-menu-link dc">
          <i class="fa fa-plus dc" aria-hidden="true"></i> Sensor mlad2dht
        </a>
      </li>
      <li class="sidebar-menu-item active">
        <a href="validar.php" class="sidebar-menu-link ">
          <i class="far fa-file-alt " aria-hidden="true"></i>Sensor mlad1ys69
        </a>
      </li>
      <li class="sidebar-menu-item ">
  ...
  function actualizarGrafica2() {
    fetch('/obtener-datos-grafica3')
      ...
      .then(data => {
        ...
        data.forEach(dato => {
          myChart2.data.labels.push(dato.fecha_hora_mlad1ys69);
          myChart2.data.datasets[0].data.push(parseFloat(dato.temperatura_mlad1ys69));
          myChart2.data.datasets[1].data.push(parseFloat(dato.humedad_mlad1ys69));
        });
