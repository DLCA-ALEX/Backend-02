...
class UserController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if ($user) {
            ...
            return redirect()->route('user.index')->with('success', 'Perfil actualizado exitosamente.');
        }

      
        return redirect()->route('user.index')->with('error', 'No se pudo encontrar al usuario.');
    }
